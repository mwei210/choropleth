...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_topojson__ = __webpack_require__(460);
...
var svg = __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* select */](".map").append("svg")
            .attr("height", height + margin.top + margin.bottom)
            .attr("width", width + margin.left + margin.right)
            .style("display", "block")
            .style("margin", "15px auto");

var projection = __WEBPACK_IMPORTED_MODULE_0_d3__["d" /* geoAlbersUsa */]()
                   .translate([ width / 2, height / 2 ])
                   .scale(1366);

var path = __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* geoPath */]()
             .projection(projection);

var tooltip = __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* select */](".map").append("div")
                .attr("class", "tooltip")
                .style("opacity", 0);
...
var color = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* scaleThreshold */]()
...
__WEBPACK_IMPORTED_MODULE_0_d3__["g" /* queue */]()
  .defer(__WEBPACK_IMPORTED_MODULE_0_d3__["f" /* json */], "build/gz_2010_us_050_00_20m.json")
  .defer(__WEBPACK_IMPORTED_MODULE_0_d3__["a" /* csv */], "data/ACS_15_5YR_S1902_with_ann.csv")
  .await(ready);
...
function ready(error, us, income) {
  ...
  g.selectAll("path")
    .attr("class", "counties")
    .data(__WEBPACK_IMPORTED_MODULE_1_topojson__["feature"](us, us.objects.counties).features)
    .enter().append("path")
      .attr("d", path)
      .style("fill", d => {
      ...
      .on("mouseover", function(d) {
        __WEBPACK_IMPORTED_MODULE_0_d3__["i" /* select */](this)
          .transition()
          .duration(250)
          .ease(__WEBPACK_IMPORTED_MODULE_0_d3__["b" /* easeLinear */])
          .style("opacity", 1);
      ...
      .on("mousemove", d => {
        tooltip.style("top", (__WEBPACK_IMPORTED_MODULE_0_d3__["c" /* event */].layerY + 5) + "px")
               .style("left", (__WEBPACK_IMPORTED_MODULE_0_d3__["c" /* event */].layerX + 20) + "px");
      });

  g.append("g")
    .attr("class", "states")
    .data(__WEBPACK_IMPORTED_MODULE_1_topojson__["feature"](us, us.objects.states).features)
    .enter().append("path")
    .attr("d", path)

  g.append("path")
    .datum(__WEBPACK_IMPORTED_MODULE_1_topojson__["mesh"](us, us.objects.states, (a, b) => (a !== b)))
    .attr("class", "mesh")
    .attr("d", path);
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_10_d3_ease__["b"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_12__src_projection_albersUsa__["a"]; });
